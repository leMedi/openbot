...
export const MCP_CATALOG = [
  ...
  },
  {
    ...
    name: "ClickUp",
    description:
      "Work with tasks, docs, chat, and time tracking across your workspace.",
    searchTerms: [
      "clickup",
      "tasks",
      "tickets",
  ...
  },
  {
    ...
    name: "monday.com",
    description:
      "Run boards, items, and workflows across your monday.com workspace.",
    searchTerms: [
      "monday",
      "monday.com",
      "tasks",
  ...
  },
  {
    ...
    name: "Atlassian",
    description:
      "Work with Jira issues and Confluence pages across your Atlassian sites.",
    searchTerms: [
      "atlassian",
      "jira",
      "confluence",
  ...
  },
  {
    ...
    icon: {
      ...
      color: `#${siCloudflareworkers.hex}`,
    },
    skills: [
      "Manage Workers",
      "Query KV and R2",
      "Inspect D1 databases",
      "Read bindings",
    ],
  },
  {
